...
import static com.bumyeong.batterystarter.DeviceDetails.kBootloaderSecurityVersion;
import static com.bumyeong.batterystarter.Password.ACTION_PASSWORD_UPDATED;
import static com.bumyeong.batterystarter.PasswordKind.OTAPasswordKind;
...
public class FirmwareUpdate extends AppCompatActivity implements SelectionChangedListener {
    ...
    {
        SharedPreferences sp = mContext.getSharedPreferences("com.bumyeong.batterystarter", MODE_PRIVATE);
