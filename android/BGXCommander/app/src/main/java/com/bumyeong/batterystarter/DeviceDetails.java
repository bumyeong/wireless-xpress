...
import static com.bumyeong.batterystarter.PasswordKind.BusModePasswordKind;
import static com.bumyeong.batterystarter.TextSource.LOCAL;
...
//                        processText(stringReceived, REMOTE);
        ...
        mSendButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final SharedPreferences sp = mContext.getSharedPreferences("com.bumyeong.batterystarter", MODE_PRIVATE);
