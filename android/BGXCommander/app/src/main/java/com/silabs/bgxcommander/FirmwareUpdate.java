...
import static com.bumyeong.btlinkap.DeviceDetails.kBootloaderSecurityVersion;
import static com.bumyeong.btlinkap.Password.ACTION_PASSWORD_UPDATED;
import static com.bumyeong.btlinkap.PasswordKind.OTAPasswordKind;
...
public class FirmwareUpdate extends AppCompatActivity implements SelectionChangedListener {
    ...
    {
        SharedPreferences sp = mContext.getSharedPreferences("com.bumyeong.btlinkap", MODE_PRIVATE);
